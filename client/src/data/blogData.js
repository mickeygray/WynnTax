const blogData = [
  {
    ...
    image: "/images/what-is-a-substitute-for-return-sfr-and-why-it-hurts.png",
    teaser:
  ...
  },
  {
    ...
    image: "/images/irs-erc-form-907-extension-april-2026.png",
    teaser:
    ...
    contentBody: [
      ...
      "<h2>How Wynn Tax Solutions Can Help</h2>",
      "<p>At Wynn Tax Solutions, we work with businesses and individuals who are fighting IRS disallowances, audits, and collection actions—including ERC disputes. If you filed for the Employee Retention Credit and the IRS denied your claim, we can help you:</p>",
  ...
  },
  {
    ...
    image: "/images/irs-tax-debt-help-online-tool-launched-april-2026.png",
    teaser:
    ...
    contentBody: [
      ...
      "<h2>How Wynn Tax Solutions can help</h2>",
      "<p>If you've used the new tool and it pointed you toward an installment agreement, CNC, or Offer in Compromise — and you want help actually getting it across the finish line — that's where Wynn Tax Solutions comes in. We work with taxpayers through the entire resolution process, from compliance work through final acceptance, including the cases where the IRS pushes back and a tool can't help. If you authorize us and we're engaged, we communicate with the IRS directly so you don't have to.</p>",
  ...
  },
  {
    ...
    image: "/images/irs-collection-notice-sequence-after-tax-day.png",
    teaser:
    ...
    contentBody: [
      ...
      "</ol>",
      "<h2>How Wynn Tax Solutions can help</h2>",
      "<p>If you've received any of the notices in this chain — or you're not sure which one is in your mailbox — Wynn Tax Solutions can review your situation and pick the path that actually applies to you. We work with taxpayers at every stage of IRS collection, from the first CP14 to active levies that need to be released. If you authorize us and we're engaged, we communicate with the IRS directly so you don't have to.</p>",
...

  {
    ...
    image: "/images/wynn-tax-day-banner.png",
    teaser:
    ...
    contentBody: [
      ...
      "<h2>How Wynn Tax Solutions can help</h2>",
      "<p>If you're facing a balance you can't pay, an unfiled return, or both — Wynn Tax Solutions can help you understand your options and move toward a real resolution. We work with taxpayers at every stage of IRS collection, from first notices to active levies. If you authorize us and we're engaged, we communicate with the IRS directly so you don't have to.</p>",
  ...
  },
  {
    ...
    contentBody: [
      ...
      "<p>Wynn Tax Solutions can help you understand what the notice means, what deadlines matter, and whether a payment arrangement, hearing request, or another strategy makes the most sense. If you authorize us and we’re engaged, we can communicate with the IRS on your behalf and help you work toward a realistic solution.</p>",
  ...
  },
  {
    ...
    image: "/images/wynn-texas-state-tax-guide.png",
    teaser:
    ...
    contentBody: [
      ...
      "<h2>How Wynn Tax Solutions helps Texas taxpayers</h2>",
      "<p>Wynn Tax Solutions helps clients resolve the Texas Comptroller tax problems by building a clear plan — whether that means catching up on filings, requesting a payment plan, responding to notices, or evaluating whether a compromise or other relief path is realistic.</p>",
      ...
      "<p>If you owe Texas tax, received a notice, or feel like you're falling behind, reach out to Wynn Tax Solutions. A clear plan now is usually cheaper than waiting until collections get more aggressive.</p>",
    ],
  },
  {
    ...
    image: "/images/missouri-income-tax-guide.png",
    teaser:
    ...
    contentBody: [
      ...
      "<h2>How Wynn Tax Solutions helps Missouri taxpayers</h2>",
      "<p>Wynn Tax Solutions helps clients resolve Missouri Department of Revenue tax problems by building a clear plan — whether that means catching up on filings, requesting a payment plan, addressing liens/garnishments, or evaluating whether a Missouri Offer in Compromise is realistic.</p>",
      ...
      "<p>If you owe Missouri income tax, received a Missouri DOR notice, or feel like you’re falling behind, reach out to Wynn Tax Solutions. A clear plan now is usually cheaper than waiting until liens or garnishments start.</p>",
    ],
  },
  {
    ...
    image: "/images/wynn-california-tax-guide.png",
    teaser:
    ...
    contentBody: [
      ...
      "<h2>How Wynn Tax Solutions can help</h2>",
      "<p>If you owe California income tax, have unfiled years, or received an FTB notice and you’re not sure what comes next, Wynn Tax Solutions can help you get clarity and build a plan. We help clients get organized, evaluate payment and relief options, and (when authorized) communicate with tax agencies on your behalf.</p>",
  ...
  },
  {
    ...
    image: "/images/sotu-tax-money-highlights.png",
    teaser:
    ...
    contentBody: [
      ...
      "<h2>How Wynn Tax Solutions can help</h2>",
      "<p>Wynn Tax Solutions helps taxpayers get clarity and a plan — especially when there’s tax debt, unfiled returns, or active collections. If you authorize us, we can communicate with the IRS on your behalf and work toward a resolution strategy that matches your situation.</p>",
      "<p><strong>If you’re unsure what a new tax headline means for you, or you already owe back taxes,</strong> contact Wynn Tax Solutions for a consultation and next-step plan.</p>",
    ],
  },
  {
  ...
  },
  {
    ...
    contentBody: [
      ...
      "<h2>Why Many Firms Struggle—And How Wynn Tax Solutions Is Different</h2>",
      "<p>Many tax relief outfits are built for ACS phone negotiations, not field enforcement. With a Revenue Officer, inexperience can mean <strong>overpaying</strong>, <strong>missed defenses</strong>, or <strong>avoidable seizures</strong>. <strong>Wynn Tax Solutions</strong> fields seasoned tax attorneys and enrolled agents who regularly confront ROs, assert your rights, and structure resolutions that protect income and assets while satisfying IRS demands.</p>",

      "<h2>Take Action Now</h2>",
      "<p>If a Revenue Officer has contacted you, the situation is serious—but manageable with the right steps. <a href='/contact-us'>Contact Wynn Tax Solutions</a> for a confidential review. We’ll engage the RO on your behalf, prioritize compliance, and move quickly toward the <strong>least invasive</strong> resolution available for your facts and budget.</p>",
    ],
  },
  ...
  },
  {
    ...
    image: "/images/Taxpayer-Bill-Of-Rights.png",
    teaser:
