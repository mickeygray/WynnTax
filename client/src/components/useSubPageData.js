  ...
  return useMemo(
    () => ({
      "tax-relief/tax-consultation": {
        ...
        body: [
          "Navigating the complexities of taxes can often feel overwhelming. With so many rules, deadlines, and changing regulations, it’s easy to feel lost or uncertain about your obligations. That’s where our tax consultation services come in. At Wynn Tax Solutions, we are committed to making the process as simple and stress-free as possible, offering personalized guidance to help you make informed decisions.",
      ...
      "tax-relief/tax-preparation": {
        ...
        body: [
          "Filing taxes can often feel like a daunting and stressful task, especially with the ever-changing tax laws and the complexity of the forms involved. At Wynn Tax Solutions, we believe that tax preparation doesn’t have to be a burden. Our professional tax preparation services are designed to simplify the entire process, ensuring that you maximize your savings while ensuring accuracy and compliance every step of the way.",
          ...
          "At Wynn Tax Solutions, we believe that tax season should be a time of peace of mind, not worry...",
          "If you’re ready to make tax season a worry-free experience, contact Wynn Tax Solutions today...",
        ],
      },
      "tax-relief/tax-settlement": {
        ...
        body: [
          "Facing tax debt or struggling to resolve a dispute with the IRS can be one of the most stressful experiences you may encounter. However, at Wynn Tax Solutions, we are here to help guide you through the complexities of tax settlement and provide the support you need to regain control of your finances. Our tax settlement services specialize in negotiating with the IRS on your behalf to reach a resolution that is fair and manageable for you.",
      ...
      "tax-resolution/tax-representation": {
        ...
        body: [
          "When you’re facing the IRS, the stress and uncertainty can feel overwhelming. Navigating the complex world of tax law and dealing with the IRS can be intimidating, especially when you’re uncertain about your rights and options. That’s where professional tax representation comes in. At Wynn Tax Solutions, we stand by your side to ensure that you are fully represented and your interests are protected throughout the entire process.",
      ...
      "tax-resolution/dealing-with-the-irs": {
        ...
        body: [
          ...
          "When you work with Wynn Tax Solutions, we take over all communication with the IRS on your behalf. Whether you’ve received a simple letter or are facing a full audit, we ensure that every document is properly submitted, deadlines are met, and your responses are in full compliance with IRS requirements. You don’t have to deal with the stress of deciphering IRS language or wondering if you’ve handled the matter correctly. Our team handles the details so you can focus on what matters most in your life.",
      ...
      "tax-resolution/irs-innocent-spouse": {
        ...
        body: [
          ...
          "If you are facing an audit or IRS collection efforts related to your spouse’s or ex-spouse’s tax debt, we will work directly with the IRS to advocate on your behalf. Our goal is to secure the best possible outcome for you, whether that’s obtaining relief from the tax liability or negotiating the right settlement. Get in touch with us today at Wynn Tax Solutions to learn more about our services and how we can represent you!",
        ],
      },
      "tax-resolution/state-tax-relief": {
        ...
        body: [
          "Tax problems don’t just come from the IRS – they can arise at the state level as well. Whether you’re dealing with state income tax, sales tax, or other state tax issues, navigating the rules and deadlines can be overwhelming. At Wynn Tax Solutions, we’re here to simplify the process and help you find the best solution to resolve your state tax issues.",
          ...
          "State tax issues can feel overwhelming, but you don’t have to face them alone. Get in touch with us at Wynn Tax Solutions today to schedule a consultation and learn how we can help resolve your state tax problems. Let us help you regain control of your financial future.",
        ],
      },
      ...
      "tax-resolution/tax-prep-and-planning": {
        ...
        body: [
          "Effective tax preparation and planning are essential for minimizing liabilities and maximizing savings. At Wynn Tax Solutions, we provide accurate tax filing services and strategic planning to help you stay ahead of your tax obligations and avoid future issues.",
      ...
      "tax-resolution/unified-tax-returns": {
        ...
        body: [
          "Managing multiple tax filings or correcting errors from past returns can be overwhelming. At Wynn Tax Solutions, our Unified Tax Return Services simplify the process, ensuring all your filings are accurate, complete, and compliant with tax laws. Whether you need to consolidate returns or amend previous filings, we provide expert support to streamline your tax situation.",
          ...
          "If you need to consolidate filings or correct past errors, Wynn Tax Solutions is here to help. Contact us today to simplify your tax situation and ensure your filings are accurate and compliant.",
        ],
      },
      ...
      "tax-resolution/payroll-tax-relief": {
        ...
        body: [
          ...
          "At Wynn Tax Solutions, we understand the complexities of payroll tax issues and work closely with you to resolve them efficiently. Our experienced tax professionals will assess your situation, reviewing the amount of payroll taxes owed, any penalties or interest that have accrued, and any other factors contributing to your tax issues.",
          ...
          "If you’re facing payroll tax issues, don’t wait until they escalate into larger problems. Contact us at Wynn Tax Solutions today to schedule a consultation. Our team of experts will evaluate your situation and help you find the best solution for resolving your payroll tax liabilities, protecting your business from further penalties, and keeping your operations running smoothly.",
        ],
      },
      "tax-resolution/wage-garnishment-relief": {
        ...
        body: [
          ...
          "At Wynn Tax Solutions, we work directly with the IRS to stop or reduce wage garnishments. Our team of tax professionals will evaluate your situation and develop a customized strategy to address your tax debt and halt the garnishment. We understand the pressure that comes with having your wages garnished, and we are here to help you find a solution that minimizes the impact on your financial well-being.",
      ...
      "tax-negotiation/currently-not-collectible": {
        ...
        body: [
          ...
          "Securing CNC status can be complex, especially when you’re dealing with financial hardship. Our team at Wynn Tax Solutions has the expertise to guide you through the entire process, ensuring that all the necessary documentation is provided and that your financial situation is accurately represented to the IRS.",
      ...
      "tax-negotiation/irs-installment-plans": {
        ...
        body: [
          ...
          "Don’t let tax debt overwhelm you — take the first step today toward resolving your tax obligations and achieving financial peace of mind with an IRS installment plan. Get in touch with us today at Wynn Tax Solutions for expert help that you can trust!",
        ],
      },
      ...
      "tax-negotiation/offer-in-compromise": {
        ...
        body: [
          "If you’re struggling with tax debt and unable to pay the full amount owed, an Offer in Compromise (OIC) might be the solution you’ve been searching for. This IRS program allows you to settle your tax debt for less than the full amount, providing much-needed relief for those facing financial hardship. At Wynn Tax Solutions, we specialize in helping individuals and businesses navigate the Offer in Compromise process. Our team will evaluate your eligibility, prepare your application, and negotiate with the IRS on your behalf to secure the best possible outcome.",
          ...
          "It’s important to note that submitting an OIC does not guarantee approval. The IRS reviews each case individually, and they may reject an offer if they believe the amount offered is not acceptable. However, our team at Wynn Tax Solutions will work tirelessly to ensure your application has the best chance of success.",
          "If you’re struggling with tax debt and can’t afford to pay the full amount, an Offer in Compromise may be the solution you need to reduce your debt and get back on track. Reach out to us at Wynn Tax Solutions today to schedule a consultation. Our team of experts will assess your eligibility, guide you through the OIC process, and negotiate with the IRS on your behalf to help you secure the relief you deserve.",
        ],
      },
      "tax-negotiation/offer-in-compromise": {
